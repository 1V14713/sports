<?php
/**
* @version $Id: french.php 434 2012-06-28 15:47:22Z eska $
* @package phpmygpx
...
DEFINE('_APP_TITLE','gestion des données');
...
DEFINE('_CMN_NO_ITEM_SELECTED','Pas d\'objet sélectionné!');
...
DEFINE('_MENU_WPT_CREATE','créer le point de cheminement');
...
DEFINE('_MENU_RSS_FEED','Flux RSS');
...
DEFINE('_TRC_SHOW_ITEMS_ON_MAP','Voir les objets sélectionnés sur la carte');
...
/** waypoints.php */
DEFINE('_WPT_CLICK_TO_CHANGE','Cliquez pour modifier');
DEFINE('_WPT_EDIT_MAP_MAN','Déplacez vous puis zoomez sur la carte. Déterminez ensuite la position en cliquant sur la carte.');
DEFINE('_WPT_CREATED','Point de cheminement créé.');
...
DEFINE('_PHOTO_IPTC_OBJECTNAME','champ IPTC "nom de objet" (ObjectName)');
DEFINE('_PHOTO_IPTC_HEADLINE','champ IPTC "titre" (Headline)');
DEFINE('_PHOTO_IPTC_CAPTION','champ IPTC "description" (Caption/Abstract)');
