<?php
/**
* @version $Id: german.php 434 2012-06-28 15:47:22Z eska $
* @package phpmygpx
...
DEFINE('_APP_TITLE','Trackpoint-Verwaltung');
...
DEFINE('_MENU_WPT_CREATE','Wegpunkt anlegen');
...
/** waypoints.php */
DEFINE('_WPT_CLICK_TO_CHANGE','klicken um auszuw&auml;hlen');
DEFINE('_WPT_EDIT_MAP_MAN','Kartenausschnitt ausw&auml;hlen und Position durch Klick in die Karte festlegen.');
DEFINE('_WPT_CREATED','Wegpunkt wurde angelegt.');
...
DEFINE('_PHOTO_IPTC_OBJECTNAME','IPTC-Feld "Formaler Titel" (ObjectName)');
DEFINE('_PHOTO_IPTC_HEADLINE','IPTC-Feld "&Uuml;berschrift" (Headline)');
DEFINE('_PHOTO_IPTC_CAPTION','IPTC-Feld "Beschreibung" (Caption/Abstract)');
