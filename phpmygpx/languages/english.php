...
DEFINE('_APP_TITLE','track point management');
...
DEFINE('_MENU_WPT_CREATE','create Waypoint');
...
/** waypoints.php */
DEFINE('_WPT_CLICK_TO_CHANGE','Click to change');
DEFINE('_WPT_EDIT_MAP_MAN','Move and zoom into the map, then set position by clicking on the map.');
DEFINE('_WPT_CREATED','Waypoint created.');
...
DEFINE('_PHOTO_IPTC_OBJECTNAME','IPTC field "title" (ObjectName)');
DEFINE('_PHOTO_IPTC_HEADLINE','IPTC field "headline" (Headline)');
DEFINE('_PHOTO_IPTC_CAPTION','IPTC field "description" (Caption/Abstract)');
