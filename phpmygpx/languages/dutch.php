<?php
/**
* @version $Id: dutch.php 434 2012-06-28 15:47:22Z eska $
* @package phpmygpx
...
DEFINE('_APP_TITLE','Trackpoint-beheer');
...
DEFINE('_CMN_MAX_FILE_SIZE','maximale bestandsgrootte: ');
DEFINE('_CMN_NO_ITEM_SELECTED','Niets geselecteerd!');
DEFINE('_CMN_COPY_DATE','Kopiedatum');
...
DEFINE('_CMN_UPLOAD_ERR_SIZE','Het ge&uuml;ploade bestand is te groot.');
DEFINE('_CMN_UPLOAD_ERR_PARTIAL','Het bestand is slechts gedeeltelijk ge&uuml;pload.');
DEFINE('_CMN_UPLOAD_ERR_NO_FILE','Er werd niets ge&uuml;pload.');
DEFINE('_CMN_UPLOAD_ERR_NO_TMP_DIR','De tijdelijke map ontbreekt.');
DEFINE('_CMN_UPLOAD_ERR_CANT_WRITE','Fout bij het wegschrijven van het bestand.');

// database related errors, taken from PHP manual
DEFINE('_CMN_DB_CONNECT_ERR','Kan geen verbinding maken: ');
DEFINE('_CMN_DB_SELECT_ERR','Kan de database niet sleceteren: ');
DEFINE('_CMN_DB_QUERY_ERR','Fout in query: ');

DEFINE('_CMN_GEO_TAGGING','Geo-Tagging');
DEFINE('_CMN_GEO_TAGGING_MAN','Selecteer een GPX-bestand voor automatische geo-tagging.');
DEFINE('_CMN_TIMEZONE','Tijdzone');
DEFINE('_CMN_TIMEZONE_CAM','Tijdzone van de camera');
...
DEFINE('_CMN_VIEW_DIR','Kijkrichting');
DEFINE('_CMN_MOVE_DIR','Beweegrichting');
...
Indien uw database <b>"shared hosted"</b> is, dan hebt u waarschijnlijk maar 1 gebruikersaccount. In dat geval gebruikt u de gegevens van dit account voor <b>zowel</b> het configuratiebestand <b>alsook</b> voor dit installatiescript.');
...
DEFINE('_INST_PROG_CHECKS','Map-toegangsrechten en servermogelijkheden worden nu getest...');
DEFINE('_INST_PROG_PHOTOS_DISABLED','Fotofuncties zijn uitgeschakeld omwille van ontbrekende EXIF en mbstring extensies.');
...
DEFINE('_MENU_WPT_CREATE','Waypoint maken');
...
DEFINE('_MENU_HOME','Startpagina');
DEFINE('_MENU_ABOUT','Info...');
DEFINE('_MENU_BOOKMARK','Bladwijzers');
DEFINE('_MENU_RSS_FEED','RSS feed');
...
DEFINE('_TRC_SHOW_ITEMS_ON_MAP','Toon selectie op de kaart');
...
DEFINE('_TRC_UPL_SUCCESS','Bestand werd succesvol ge&uuml;pload: ');
...
/** waypoints.php */
DEFINE('_WPT_CLICK_TO_CHANGE','Klik om te wijzigen');
DEFINE('_WPT_EDIT_MAP_MAN','Beweeg en zoom in op de kaart, klik op de kaart om te positioneren.');
DEFINE('_WPT_CREATED','Waypoint gemaakt.');
...
DEFINE('_PHOTO_IPTC_OBJECTNAME','IPTC-veld "naam" (ObjectName)');
DEFINE('_PHOTO_IPTC_HEADLINE','IPTC-veld "titel" (Headline)');
DEFINE('_PHOTO_IPTC_CAPTION','IPTC-veld "omschrijving" (Caption/Abstract)');
DEFINE('_PHOTO_TIME_OFFSET','Tijdverschil');
DEFINE('_PHOTO_TIME_OFFSET_MAN','Tijdverschil [GPS - camera] in seconden');
DEFINE('_PHOTO_LOCATION_FROM_EXIF','Locatie uit EXIF-header gelezen: ');
DEFINE('_PHOTO_LOCATION_FROM_TRKPT','Locatie uit GPX gelezen: ');
DEFINE('_PHOTO_NO_LOCATION','Geen opnamelocatie gevonden!');
...
DEFINE('_IMPORT_PHP_ERROR','Sorry, er gaat iets fout! Indien u een foutenrapport wil versturen, voeg dan onderstaande regels toe:');
