<?php
/**
* @version $Id: spanish.php 434 2012-06-28 15:47:22Z eska $
* @package phpmygpx
...
DEFINE('_APP_TITLE','gestión de puntos de trazado');
...
DEFINE('_CMN_NO_ITEM_SELECTED','Ningún item seleccionado!');
...
DEFINE('_MENU_WPT_CREATE','Crear Waypoint');
...
DEFINE('_MENU_RSS_FEED','Fuente RSS');
...
DEFINE('_TRC_SHOW_ITEMS_ON_MAP','Mostrar items seleccionados sobre el mapa');
...
/** waypoints.php */
DEFINE('_WPT_CLICK_TO_CHANGE','Hacer click para cambiar');
DEFINE('_WPT_EDIT_MAP_MAN','Mover y hacer zoom en el mapa, después establecer la posición haciendo click sobre el mapa.');
DEFINE('_WPT_CREATED','Waypoint creado.');
...
DEFINE('_PHOTO_IPTC_OBJECTNAME','Campo IPTC "nombre" (ObjectName)');
DEFINE('_PHOTO_IPTC_HEADLINE','Campo IPTC "título" (Headline)');
DEFINE('_PHOTO_IPTC_CAPTION','Campo IPTC "descripción" (Caption/Abstract)');
