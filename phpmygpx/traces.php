<?php
/**
* @version $Id: traces.php 441 2012-07-26 21:52:47Z eska $
* @package phpmygpx
...
function viewGPX($page, $sort, $order, $limit) {
	...
	// set strict MySQL config, useful for optimizing SQL queries
	// could be removed as soon as bug FS#75 is closed
	if($DEBUG) {
		out('SQL_MAX_JOIN_SIZE=150000;', 'OUT_DEBUG');
		$result = db_query("SET SQL_MAX_JOIN_SIZE=150000;");
		$result = db_query("SET SQL_BIG_SELECTS=0;");
	}
	// workaround for bug FS#75, set SQL_BIG_SELECTS=1 on line 12 if necessary
	if(SQL_BIG_SELECTS) {
