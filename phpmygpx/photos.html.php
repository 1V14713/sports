<?php
/**
* @version $Id: photos.html.php 428 2012-05-21 22:36:19Z eska $
* @package phpmygpx
...
class HTML_photos {
    ...
    function viewBatchImportTableFooter($path, $gpx_files) {
        ...
        echo "<input type='radio' name='title_opt' value='IPTC_Headline' checked />"._PHOTO_IPTC_HEADLINE."<br/>\n";
        echo "<input type='radio' name='title_opt' value='IPTC_ObjectName' />"._PHOTO_IPTC_OBJECTNAME."<br/>\n";
        ...
        echo "<input type='radio' name='desc_opt' value='IPTC_Caption' checked />"._PHOTO_IPTC_CAPTION."<br/>\n";
        echo "<input type='radio' name='desc_opt' value='IPTC_Headline' />"._PHOTO_IPTC_HEADLINE."<br/>\n";
        echo "<input type='radio' name='desc_opt' value='IPTC_ObjectName' />"._PHOTO_IPTC_OBJECTNAME."<br/>\n";
