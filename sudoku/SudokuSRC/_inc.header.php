...
/* -------------------------------------------
header.inc.php -> à insérer avant le code html 
---------------------------------------------*/

  session_start(); //pour enregistrement de la solution de la grille  

  require '_inc.config.php';

  require 'class/_class.Sudoku.inc.php';
  require 'class/_class.Template.inc.php';
  
  $tpl = new template($path.'Templates/');
  
  include 'sudoku.php';

  if($refresh) // la grille n'a pas été trouvée... Timeout
